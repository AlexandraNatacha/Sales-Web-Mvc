...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d2 = new Department(2, "Eletrionics");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");

            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new System.DateTime(1998, 4, 21), 1000.00, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new System.DateTime(1979, 12, 31), 3500.00, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alexgrey@gmail.com", new System.DateTime(1988, 1, 15), 2200.00, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new System.DateTime(1993, 11, 30), 3000.00, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new System.DateTime(2000, 1, 9), 4000.00, d3);
            Seller s6 = new Seller(6, "Alex Pink", "alex@gmail.com", new System.DateTime(1997, 3, 4), 3000.00, d2);
